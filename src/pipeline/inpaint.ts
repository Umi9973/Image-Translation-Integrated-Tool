...
export function inpaintPage(
  ...
  return new Promise((resolve, reject) => {
    ...
    const msg: Record<string, unknown> = {
      type: 'inpaint',
      imageBlob,
      bubbles: bubbles.map(b => ({ id: b.id, rect: b.rect, shape: b.shape, points: b.points, inpaint_color: b.inpaint_color, is_background: b.is_background, rotation: b.rotation })),
    }
    if (textMask) {
